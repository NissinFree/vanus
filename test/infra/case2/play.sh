...
# vanus-bench component store send --total-number 1000000 --parallelism 16 --no-clean-cache --payload-size 10240 --name e2e-component-store-3replicas --without-mongodb
